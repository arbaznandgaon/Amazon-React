      ...
      <div className="">
        <div className=" ">
          ...
          <input
            ...
            className="border-2 mt-2 py-2 w-1/2 h-10 rounded-t-lg"
          />
          <div className="bg-gray-300 mx-auto  w-1/2 h-10 space-x-2 flex text-5xl items-center">
            <StoreIcon fontSize="inherit" className="" />{" "}
            <a className="text-sm">
              Shop:
              <button className="w-max px-2 ml-2 py-1 border border-black bg-white">
                Amazon <ArrowDropDownIcon />
              </button>
            </a>
          </div>
          <div className="bg-white space-x-4 pl-2  w-1/2 mx-auto h-max py-2 flex  text-4xl ">
            ...
            <div className="text-sm fle">
              ...
              <input className="w-[42rem] rounded-md h-8 border border-black ml-" />
              <br />
          ...
          <div className="bg-white  px-2 w-1/2 mx-auto h-max py-2 flex space-x-2 text-4xl ">
            <div>
              ...
              <ErrorIcon /> <a className="text-lg">Consider image rights</a>
              <br />
              <a className="text-lg text-blue-500 cursor-pointer">
                Set image features
              </a>
            </div>
            <div className="space-y-3 ">
              <div>
                <a className="text-sm flex justify-start font-semibold">
                  Small image URL
                </a>
          ...
          <div className="grid grid-cols-2 w-1/2 mx-auto py-2 bg-white px-4">
            ...
            <div className="flex text-5xl text-gray-500 border pl-12 border-gray-300 ">
              <div className="text-lg ">
                <a className="flex justify-start">
                  Total Reviews:
                  <HelpIcon />{" "}
            ...
            <div className="flex text-5xl col-span-2 text-gray-500 border border-gray-300 ">
              <div className="text-lg px-4">
                ...
                <textarea
                  id="message"
                  name="message"
                  class="w-[42rem]  bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-4 resize-none leading-6 transition-colors duration-200 ease-in-out"
                ></textarea>
              </div>
            </div>
          </div>
